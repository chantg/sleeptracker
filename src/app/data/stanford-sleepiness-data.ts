...
export class StanfordSleepinessData extends SleepData {
	...
	summaryString():string {
		return "At "+this.loggedAt.toLocaleDateString('en-US', { weekday: 'long', month: 'long', day: 'numeric' ,  hour: 'numeric', minute: 'numeric'})+" User Logged "+this.loggedValue + ": " + StanfordSleepinessData.ScaleValues[this.loggedValue];
	}
}
